...
Clicking the 22 px rail opens a compact details card with the available short-period and long-period quota and their reset times.

<p align="center">
  <img src="docs/assets/demo/codex-quota-rail-ui-demo.png" width="100%" alt="Codex available quota rail with its click-open details card">
</p>
...
See [简体中文](README.md), [privacy](docs/privacy.md), [architecture](docs/architecture.md), and [troubleshooting](docs/troubleshooting.md).
