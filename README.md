...
[Download the Windows and macOS prerelease](https://github.com/lingge66/codex-quota-rail/releases/tag/v0.1.0-rc.7). Current builds are not commercially code-signed; verify the bundled SHA-256 first.
